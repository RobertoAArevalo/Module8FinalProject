...
/**
 * This is a class called Ch. 13 which is being called from
 ...
 * A description will be presented for Ch. 13: Interfaces and Inner Classes.
 */
public class cH13 extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //Calls the super from onCreate.
        super.onCreate(savedInstanceState);
        //Sets content view base on the XML file.
        setContentView(R.layout.ch13);

        Button cH13_1; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH13_1 = findViewById(R.id.thirteen_1);

        cH13_1.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH13_1.class);
            }
        });

        Button cH13_2; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH13_2 = findViewById(R.id.thirteen_2);

        cH13_2.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH13_2.class);
            }
        });

        Button cH13_3; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH13_3 = findViewById(R.id.thirteen_3);

        cH13_3.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH13_3.class);
            }
        });
