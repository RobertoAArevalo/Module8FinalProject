...
/**
 * This is a class called Ch. 8 which is being called from
 ...
 * A description will be presented for Ch. 8: PolyMorphism and Abstract Classes.
 */
public class cH8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button cH8_1; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH8_1 = findViewById(R.id.eight_1);

        cH8_1.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH8_1.class);
            }
        });

        Button cH8_2; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH8_2 = findViewById(R.id.eight_2);

        cH8_2.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH8_2.class);
            }
        });

        Button cH8_3; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH8_3 = findViewById(R.id.eight_3);

        cH8_3.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH8_3.class);
            }
        });
