...
/**
 * This is a class called Ch. 17 which is being called from
 ...
 * A description will be presented for Ch. 17: Swing I.
 */
public class cH17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ch17);


        Button cH17_1; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH17_1 = findViewById(R.id.seventeen_1);

        cH17_1.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH17_1.class);
            }
        });

        Button cH17_2; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH17_2 = findViewById(R.id.seventeen_2);

        cH17_2.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH17_2.class);
            }
        });

        Button cH17_3; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH17_3 = findViewById(R.id.seventeen_3);

        cH17_3.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH17_3.class);
            }
        });
