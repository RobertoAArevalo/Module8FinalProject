...
/**
 * This is a class called Ch 6 which is being called from
 ...
 * A description will be presented for Ch 6: Arrays.
 */
public class cH6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button cH6_1; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH6_1 = findViewById(R.id.six_1);

        cH6_1.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH6_1.class);
            }
        });

        Button cH6_2; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH6_2 = findViewById(R.id.six_2);

        cH6_2.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH6_2.class);
            }
        });

        Button cH6_3; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH6_3 = findViewById(R.id.six_3);

        cH6_3.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH6_3.class);
            }
        });
