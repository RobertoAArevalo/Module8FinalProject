...
/**
 * This is a class called Ch. 7 which is being called from
 ...
 * A description will be presented for Ch. 7: Inheritance.
 */
public class cH7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ch7);



        Button cH7_1; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH7_1 = findViewById(R.id.seven_1);

        cH7_1.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH7_1.class);
            }
        });

        Button cH7_2; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH7_2 = findViewById(R.id.seven_2);

        cH7_2.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH7_2.class);
            }
        });

        Button cH7_3; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH7_3 = findViewById(R.id.seven_3);

        cH7_3.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH7_3.class);
            }
        });
