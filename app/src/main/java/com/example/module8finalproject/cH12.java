...
/**
 * This is a class called Ch12 which is being called from
 ...
 * A description will be presented for Ch12.
 */
public class cH12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ch12);


        Button cH12_1; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH12_1 = findViewById(R.id.twelve_1);

        cH12_1.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH12_1.class);
            }
        });

        Button cH12_2; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH12_2 = findViewById(R.id.twelve_2);

        cH12_2.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH12_2.class);
            }
        });

        Button cH12_3; //creates a variable, type button for cH1_OOP
        //Stores the button
        cH12_3 = findViewById(R.id.twelve_3);

        cH12_3.setOnClickListener(new View.OnClickListener() {
            @Override
            //this will override the function or the onClick attribute
            public void onClick(View view) {
                switchScene(view, cH12_3.class);
            }
        });
